    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table' => 'tx_users_domain_model_newsbookmark',
                'foreign_table_where' => 'AND tx_users_domain_model_newsbookmark.pid=###CURRENT_PID### AND tx_users_domain_model_newsbookmark.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
